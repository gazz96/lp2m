  ...
  <div class="edit-post-layout">
    ...
    <div class="editor-body">
      <div class="editor-center">
        <div class="editor-styles">
          ...
          <details class="wp-detail-group" open>
            <summary class="wp-detail-group__title">Info Tambahan</summary>
          ...
          <details class="wp-detail-group" open>
            <summary class="wp-detail-group__title">Timeline</summary>
            <div class="wp-detail-group__body">
              <div v-for="(t,i) in f.timeline_items" :key="i" style="display:flex;gap:8px;margin-bottom:6px;align-items:center">
                ...
                <input class="components-text-control__input" type="text" v-model="t.label" placeholder="Deskripsi..." style="flex:1" />
      ...
      <div class="editor-sidebar">
          ...
          <div class="wp-detail-group__body">
            <div class="components-base-control">
              ...
              <select class="components-select-control__input" v-model="f.status">
                <option value="draft">Draft</option><option value="publish">Publish</option>
              </select>
            </div>
            <div class="components-base-control">
              ...
              <select class="components-select-control__input" v-model="f.jenis_hibah">
                <option value="internal">Internal</option><option value="eksternal">Eksternal</option>
              </select>
            </div>
        ...
        <!-- Group: Metadata -->
        <details class="wp-detail-group" open>
          <summary class="wp-detail-group__title">Metadata</summary>
          <div class="wp-detail-group__body">
            <div class="components-base-control">
