  ...
  <div class="edit-post-layout">
    ...
    <div class="editor-body">
      ...
      <div class="editor-sidebar">
        ...
        <details class="wp-detail-group" open>
          <summary class="wp-detail-group__title">Deadline & Dana</summary>
          <div class="wp-detail-group__body">
            <div class="components-base-control">
...
const tabs=[{id:'info',label:'Info Dasar'},{id:'timeline',label:'Timeline'},{id:'panduan',label:'Panduan & Template'}]
...
function resetForm(){Object.assign(f,{title:'',content:'',status:'draft',jenis_hibah:'internal',deadline:'',dana_maks_num:0,event_eyebrow:'',info_tambahan:'',link_panduan:'',timeline_items:[],featured_media:null});selKats.value=[];selSkms.value=[];thumb.value='';editId.value=null;err.value='';activeTab.value='info'}
