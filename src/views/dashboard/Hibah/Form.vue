...
const f=reactive({title:'',content:'',status:'draft',deadline:'',deadline_time:'',dana_maks_num:0,event_eyebrow:'',info_tambahan:'',link_panduan:'',timeline_items:[] as TL[],featured_media:null as number|null,panduan_penulisan_id:null as number|null,template_dokumen_id:null as number|null,file_panduan:[] as string[],file_template:[] as string[],file_kelompok_keahlian:[] as string[],file_surat_kesanggupan:[] as string[]})
...
async function handleFileUpload(e:Event,key:'file_panduan'|'file_template'|'file_kelompok_keahlian'|'file_surat_kesanggupan'){
